...
#  Потому что существуют проблемы с политикой CORS когда пытаешься сделать напрямую запросы.
#
# Я пытался написать библиотеку на других языках программирования, но в итоге пришёл к выводу, 
#  что проще сделать свой сервер на питоне (на котором к удивлению всё работет) и парсить данные 
#  с него уже на любом другом языке
